 ...
 * @property integer $afloat_count
 * @property integer $lock_count
...
class WmsInventory extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['goods_id', 'balance_count' ], 'required'],
            [[], 'safe'],
            [['balance_count', 'afloat_count', 'lock_count'], 'integer'],
...
//                        var_dump($model->good->sku_attribute ) ;die;
                    },
                    'size' => function ($model) {
                        return $model->good->sku_attribute ;
                    },
