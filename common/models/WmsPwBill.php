...
//        5 => '付款失败',
    ...
    {
        return [
            [['ref', 'goods_id', 'goods_count', 'goods_money', 'goods_price', 'status', 'action_time', 'action_user_id', 'supplier_id', 'warehouse_id'], 'required'],
            [['goods_id', 'goods_count', 'status', 'action_user_id', 'supplier_id', 'warehouse_id', 'purchases_detail_id'], 'integer'],
